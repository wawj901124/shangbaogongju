...
# from WWSpider.autotest.config.split.globalconfig.globalConfig import gc   #导入全局变量
from WWSpider.base.activeAPI import ActiveAPI
...
from WWSpider.autotest.config.split.page.loginPage import *  #导入登录页
...
def __generateTestCases():
    ...
    apirequestdatatestcase_all = ApiRequestData.objects.filter(id=2).order_by('id')
