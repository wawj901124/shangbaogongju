...
class SpiderBase(object):
    def __init__(self,weburl):
        ...
        self.down_load_links = self.get_down_load()
    ...
    def get_web_url(self):
        ...
        for i in range(1,6):
            try:
                response = self.hs.get(url=self.web_url,timeout=5,verify=False)
        ...
        for i in range(self.range_num_down, self.range_num_up):
            ...
            if is_exist_url_count != 0:
                ...
                try:
                    ...
                    # sb2 = SpiderBase(url)
                    # 获取下载链接
                    down_load_list = sb.down_load_links
