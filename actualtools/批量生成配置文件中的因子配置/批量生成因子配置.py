...
for i in f:   #遍历读取因子文件中的每一行
    ...
    moban = """<factor factorCode="%s" findMode="OFFSET" offset="%s" mark="" len="%s" decodeType="decode4" operator="*" operand="1"/>"""\
            %(yinzi_code,str(offset_num),str(len_guding_num))  #一条数据的模板
