...
from WWDBTest.util import HTMLTestRunner as HTMLTestRunner
from WWDBTest.test.all_test_list import caselist  #调用数组文件
from WWDBTest.util.getTimeStr import GetTimeStr
from WWDBTest.util.sendEmail import SendEmail
from WWDBTest.util.myLogs import MyLogs
...
if __name__ == '__main__':
    runat = RunAllTest()
    # runat.run()
    runat.runAllTest(testproject=u"中石油项目",testmodule=u"批量替换数据库中某字段的内容")
