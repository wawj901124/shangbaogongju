...
class TestUpdateDBClass(unittest.TestCase):  # 创建测试类
    ...
    #定义点击返回函数
    def defineupdatedbdata(self,db_host,db_port,db_user,db_password,db_database,db_charset,
    ...
    def getTestFunc(db_host,db_port,db_user,db_password,db_database,db_charset,
        ...
        def func(self):
            self.defineupdatedbdata(db_host,db_port,db_user,db_password,db_database,db_charset,
                  db_biao, db_ziduan, db_xiugaiqiandezhi, db_xiugaihoudezhi,
                  db_tiaojianziduan, db_tiaojianzhi)
        return func
...
def __generateTestCases():
    ...
    updatedbdatatestcase_all = UpdateDbData.objects.filter(id=1).order_by('id')
                    ...
                    for h in range(1, db_tiaojianziduan_list_len + 1):
                        ...
                        for f in range(1, db_tiaojianzhi_list_len + 1):
                            ...
                            setattr(TestUpdateDBClass,
                                    ...
                                    TestUpdateDBClass.getTestFunc(*args))  # 通过setattr自动为TestCase类添加成员方法，方法以“test_func_”开头
