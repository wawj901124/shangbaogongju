...
def __generateTestCases():
    ...
    newaddandchecktestcase_all = NewAddAndCheck.objects.filter(test_project__contains="中石油").\
        filter(is_run_case=True).order_by('id')
    ...
    for newaddandchecktestcase in newaddandchecktestcase_all:
        ...
        for i in range(1, forcount + 1):  # 循环，从1开始
            ...
            setattr(TestNewAddClass,
                    ...
                    newaddandchecktestcaseid, newaddandchecktestcase.test_project,
                    newaddandchecktestcase.test_module,newaddandchecktestcase.test_page,
