...
def __generateTestCases():
    ...
    deleteandchecktestcase_all = DeleteAndCheck.objects.filter(test_project__contains="中石油").filter(is_run_case=True).order_by('id')
    ...
    for deleteandchecktestcase in deleteandchecktestcase_all:
        ...
        for i in range(1, forcount + 1):  # 循环，从1开始
            ...
            setattr(TestDeleteClass,
                    ...
                    deleteandchecktestcaseid,deleteandchecktestcase.test_project,
                    deleteandchecktestcase.test_module,deleteandchecktestcase.test_page,
                    deleteandchecktestcase.test_case_title, forcount_i),
