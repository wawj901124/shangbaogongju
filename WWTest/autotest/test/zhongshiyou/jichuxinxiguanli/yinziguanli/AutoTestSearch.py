...
def __generateTestCases():
    ...
    searchandchecktestcase_all = SearchAndCheck.objects.filter(test_project="中石油_迭代一").\
        filter(test_module="因子管理").filter(id=118).filter(is_run_case=True).order_by('id')
