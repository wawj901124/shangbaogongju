...
from WWTest.autotest.config.zhongshiyou.globalconfig.globalConfig import gc   #导入全局变量
...
class TestClickAndBackClass(unittest.TestCase):  # 创建测试类
    ...
    def defineclickandback(self,num,case_counts,depend_case_id,
        ...
        dom_time_NoCatch = self.activebrowser.driver.execute_script(domReady)
        ...
        pageloadtimereport.write_user = writer_user
        ...
        if page_time_NoCatch >= 1000 and page_time_NoCatch < 2000:
            ...
            pageloadtimereportonesecond.write_user = writer_user
            ...
            pageloadtimereporttwosecond.write_user = writer_user
            ...
            pageloadtimereporttheresecond.write_user = writer_user
            ...
            pageloadtimereportfoursecond.write_user = writer_user
            ...
            pageloadtimereportfivesecond.write_user = writer_user
...
def __generateTestCases():
    ...
    clickandbacktestcase_all = ClickAndBack.objects.filter(is_static_load_page_time=True).order_by('id')
    # clickandbacktestcase_all = ClickAndBack.objects.filter(id=141).order_by('id')
    ...
    for clickandbacktestcase in clickandbacktestcase_all:
        ...
        for i in range(1, forcount + 1):  # 循环，从1开始
            ...
            args.append(i)
            args.append(clickandbacktestcase.write_user)



            setattr(TestClickAndBackClass,
                    'test_func_%s_%s_%s_%s_%s_%s' % (clickandbacktestcaseid, clickandbacktestcase.test_project,
                                                     clickandbacktestcase.test_module,clickandbacktestcase.test_page,
                                                     clickandbacktestcase.test_case_title, forcount_i),
