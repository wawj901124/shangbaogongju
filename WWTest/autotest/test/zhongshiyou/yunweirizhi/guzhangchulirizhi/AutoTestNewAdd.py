...
def __generateTestCases():
    ...
    newaddandchecktestcase_all = NewAddAndCheck.objects.filter(test_project="中石油_迭代一").\
        filter(is_run_case=True).filter(test_module="运维日志").filter(test_page="故障处理日志").order_by('id')
