...
from WWTest.autotest.config.shuizhi.globalconfig.globalConfig import GlobalConfig,gc   #导入全局变量
from WWTest.base.activeBrowser import ActiveBrowser
from WWTest.util.getTimeStr import GetTimeStr
from WWTest.autotest.config.shuizhi.page.loginPage import *   #导入登录页
from WWTest.autotest.config.shuizhi.depend.clickAndBackDepend import ClickAndBackDepend,clickandbackdepend
    #导入 ClickAndBack依赖
from WWTest.autotest.config.shuizhi.depend.inputTapInputText import InputTapInputText,inputtapinputtext
from WWTest.autotest.config.shuizhi.depend.selectTapSelectOption import SelectTapSelectOption,selecttapselectoption
from WWTest.autotest.config.shuizhi.depend.selectTapSelectText import SelectTapSelectText,selecttapselecttext
from WWTest.autotest.config.shuizhi.depend.inputTapInputFile import InputTapInputFile,inputtapinputfile
from WWTest.autotest.config.shuizhi.depend.assertTipText import AssertTipText,asserttiptext
from WWTest.autotest.config.shuizhi.depend.inputTapInputDateTime import inputtapinputdatetime,InputTapInputDateTime
from WWTest.autotest.config.shuizhi.depend.radioAndReelectionLabel import RadioAndReelectionLabel,radioandreelectionlabel
...
class TestNewAddClass(unittest.TestCase):  # 创建测试类
    ...
    def definenewadd(self,num,depend_click_case_id,
        ...
        #MN重新填写
        MN_xpath = "/html/body/div[1]/div/div[1]/main/div/div/div/div[2]/div/div[2]/div/div[2]/div/div/form/div[4]/div/div/div/input"
        self.activebrowser.findEleAndInputNum(0, "xpath",
                                              MN_xpath,
                                              MN_devices_number)
    ...
    def getTestFunc(num,depend_click_case_id,
                     ...
                     page_number_xpath,
                     result_table_ele_find,result_table_ele_find_value,
                     table_colnum_counts,MN_devices_number):
...
def __generateTestCases():
    ...
    newaddandchecktestcase_all = NewAddAndCheck.objects.filter(id=237).order_by('id')
    ...
    for newaddandchecktestcase in newaddandchecktestcase_all:
        ...
        for i in range(1, forcount + 1):  # 循环，从1开始
            ...
            MN_devices_number = "chang0%s"% (forcount_i)
