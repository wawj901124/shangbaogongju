...
from WWTest.autotest.config.shuizhi.depend.radioAndReelectionLabel import RadioAndReelectionLabel, \
    radioandreelectionlabel
from WWTest.autotest.config.shuizhi.depend.iframeBodyInputText import iframebodyinputtext
