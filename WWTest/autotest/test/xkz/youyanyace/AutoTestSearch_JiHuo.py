...
from WWTest.autotest.config.xkz.youyanyace.page.loginPage import *
    ...
    def definenewadd(self,num,depend_click_case_id,
        ...
        if is_with_date:   #如果预期是查询到数据，则对数据进行验证
            ...
            self.activebrowser.findEleAndClick(0, "xpath",
                                          "/html/body/div/div/div/div[2]/div/div[1]/div[2]/div[2]/div/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[5]/div/div/span[1]/span")
            #点击弹框的确定
            self.activebrowser.findEleAndClick(0, "xpath",
...
def __generateTestCases():
    ...
    searchandchecktestcase_all = SearchAndCheck.objects.filter(id=99).order_by('id')
