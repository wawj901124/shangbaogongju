...
class TestNewAddClass(unittest.TestCase):  # 创建测试类
    ...
    def definenewadd(self,num,depend_click_case_id,
        ...
        MN_devices_number = str(int(MN_devices_number))

        li_xpath = "/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div[2]/div[2]/div/div[2]/div/form/div[8]/div/div/div[2]/div[1]/div[1]/ul/li[%s]/span" % MN_devices_number
        self.activebrowser.findEleAndClick(0, "xpath",li_xpath)
...
def __generateTestCases():
    ...
    newaddandchecktestcase_all = NewAddAndCheck.objects.filter(id=162).order_by('id')
