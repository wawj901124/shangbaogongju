...
class ShangBaoShuJu(models.Model):
    ...
    shujuduan_st = models.CharField(max_length=100, default="",null=True, blank=True, verbose_name=u"数据段_系统编码ST")
    shujuduan_cn = models.CharField(max_length=100, default="",null=True, blank=True, verbose_name=u"数据段_命令编码CN")
    shujuduan_pw = models.CharField(max_length=100, default="",null=True, blank=True, verbose_name=u"数据段_访问密码PW")
    ...
    shujuduan_flag = models.CharField(max_length=100, default="",null=True, blank=True, verbose_name=u"数据段_应答标志Flag")
    shujuduan_cp_datatime_type = models.CharField(max_length=100, default="",null=True, blank=True, verbose_name=u"数据段_指令参数CP的DataTime类型")
