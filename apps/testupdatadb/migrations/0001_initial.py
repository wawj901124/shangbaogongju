    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_ziduan', models.CharField(blank=True, default='current_page_click_ele_find_value', help_text='多个字段之间以英文半角逗号(,)隔开', max_length=1000, null=True, verbose_name='数据库中的表的字段名')),
