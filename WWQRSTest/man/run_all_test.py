...
from WWQRSTest.util import HTMLTestRunner as HTMLTestRunner
from WWQRSTest.test.all_test_list import caselist  #调用数组文件
from WWQRSTest.util.getTimeStr import GetTimeStr
from WWQRSTest.util.sendEmail import SendEmail
