...
class HandleRequestsHeaders(object):
    def handlerequestsheaders(self,activebrowser,apirequestdataid):
            ...
            for requestdatas in requestdatases:
                ...
                if requestdatas.is_auto_input:
                    ...
                    if requestdatas.is_with_time:
                        requestheader_dict_value = "%s%s"%(requestdatas.input_text,timestr)
                    else:
                        requestheader_dict_value = requestdatas.input_text
        ...
        activebrowser.outPutMyLog("requestdatas_dict:%s" % requestdatas_dict )
