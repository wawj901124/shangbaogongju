            ...
            for j in range(1, db_biao_list_len + 1):
                ...
                for h in range(1, db_tiaojianziduan_list_len + 1):
                    ...
                    for f in range(1, db_tiaojianzhi_list_len + 1):
                        ...
                        args.append(updatedbdatatestcase.db_paixuziduan)
                        args.append(updatedbdatatestcase.is_daoxu)
                        args.append(updatedbdatatestcase.db_qianjiwei)
                        return args


if __name__ == '__main__':
    arg_list = getSQLYinZi(2)
    print(arg_list)
