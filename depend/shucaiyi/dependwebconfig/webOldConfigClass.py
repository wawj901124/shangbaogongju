...
class WebOldConfig(object):
    ...
    def checkFuWuQI(self):
        self.switchToTwoFrame()
        self.activebrowser.delayTime(3)
        fuwuqi_1_input_xpath = "/html/body/form/div/div[4]/div[2]/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/input"
    ...
    def addServiceConfig(self):
        self.switchToTwoFrame()
        fuwuqidizhi_xpath = "/html/body/form/div/div[4]/div[2]/table/tbody/tr[2]/td/table/tbody/tr[2]/td[3]/input"
        ...
        fuwuqiduankou_xpath = "/html/body/form/div/div[4]/div[2]/table/tbody/tr[2]/td/table/tbody/tr[2]/td[4]/input"
        ...
        select_xieyi_xpath = "/html/body/form/div/div[4]/div[2]/table/tbody/tr[2]/td/table/tbody/tr[2]/td[5]/select[1]"
        #选择某个协议：
        self.activebrowser.findElementByXpathAndSelectOptionsNum(0,select_xieyi_xpath,shangbao_pingtai_xieyi_option_text)

        #填写MN号
        mn_input_xpath = "/html/body/form/div/div[4]/div[2]/table/tbody/tr[2]/td/table/tbody/tr[2]/td[6]/input"
        mn_input_text = str(datetime.datetime.now().strftime("%Y%m%d%H%M%S%f"))
        self.activebrowser.findEleAndInputNum(0,"xpath",mn_input_xpath,mn_input_text)
...
if __name__ == '__main__':
    select_xie_yi = "496_E"
    select_jian_kong_yin_zi_list = ["a24087"]
    ip = "192.168.101.124"
    ...
    wc = WebOldConfig(select_xie_yi,select_jian_kong_yin_zi_list,ip,service_ip,service_port,device_id)
    wc.run()
