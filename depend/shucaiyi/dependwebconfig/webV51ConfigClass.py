...
class WebVFiveOneConfig(object):
    ...
    #切换到第二个frame下的第一个frame
    def switchToTwo_One_Frame(self):
        self.switchToTwoFrame()
        frame_xpath = "/html/frameset/frame[1]"
        frame_ele = self.activebrowser.findELe("xpath",frame_xpath)
        self.activebrowser.swithToIframe(frame_ele)  #切换到串口协议所在frame
        print("切换到第二个iframe框中的第一个iframe框")

    #切换到第二个frame下的第二个frame
    def switchToTwo_Two_Frame(self):
        self.switchToTwoFrame()
        frame_xpath = "/html/frameset/frame[2]"
        frame_ele = self.activebrowser.findELe("xpath",frame_xpath)
        self.activebrowser.swithToIframe(frame_ele)  #切换到串口协议所在frame
        print("切换到第二个iframe框中的第二个iframe框")
    ...
    def clickCaiJiPeiZhi(self):
        ...
        #点击“串口参数配置”
        caijipeizhi_link_text = "采集配置"
        self.activebrowser.findEleAndClick(0, "link_text", caijipeizhi_link_text )  # 点击“采集配置”
        self.quiteCurrentFrame()

    #查看串口4是否被选中，没有选中，则点击选择，否则，不做任何操作
    def checkChuanKou(self):
        self.switchToTwo_Two_Frame()
        self.activebrowser.delayTime(3)
        chuankou_4_input_xpath = "/html/body/form/div/div/table/tbody/tr[6]/td[3]/input"
    ...
    def selectXieYi(self):
        ...
        self.switchToTwo_Two_Frame()
        select_xieyi_xpath = "/html/body/form/div/div/table/tbody/tr[6]/td[8]/select"
        ...
        #填写设备ID
        device_id_xpath = "/html/body/form/div/div/table/tbody/tr[6]/td[9]/input"
        device_id_input_text = self.device_id
        self.activebrowser.findEleAndInputNum(0,"xpath",device_id_xpath,device_id_input_text)

        #点击保存
        save_xpath = "/html/body/form/div/div/table/tbody/tr[13]/td/input[1]"
    ...
    #点击“系统配置”
    def clickXiTongPeiZhi(self):
        self.switchToOneFrame()
        #点击“系统配置”
        xitongpeizhi_link_text = "系统配置"
        self.activebrowser.findEleAndClick(0, "link_text", xitongpeizhi_link_text )  # 点击“系统配置”
        self.quiteCurrentFrame()


    #点击“因子配置”
    def clickYinZiPeiZhi(self):
        self.switchToTwo_One_Frame()
        #点击“因子配置”
    ...
    def getAllYinZi(self):
        self.clickXiTongPeiZhi()  #点击“系统配置”
        self.clickYinZiPeiZhi()  #点击“因子配置”
        self.switchToTwo_Two_Frame()
        allyinzi_tbody_xpath = "/html/body/form/div/div/table/tbody"
        #因子代码是否在“因子配置”页
    ...
    def clickJianCeYinZiLieBiao(self):
        self.switchToTwo_One_Frame()
        #点击“监测因子配置”
        jianceyinziliebiao_link_text = "监测因子配置"
        self.activebrowser.findEleAndClick(0, "link_text", jianceyinziliebiao_link_text )  # 点击“监测因子配置”
        self.quiteCurrentFrame()

    #点击“清除所有”
    def clickDeleteAllYinZi(self):
        self.switchToTwo_Two_Frame() # 切换到第二个frame下的第二个iframe
    ...
    def addJianCeYinZi(self):
        for yinzi_code in self.select_jian_kong_yin_zi_list:
            ...
            yinzidaimamingcheng_xpath = "/html/body/form/div/div/table[1]/tbody/tr/td[2]/select"
            self.activebrowser.findElementByXpathAndSelectOptionsNum(0, yinzidaimamingcheng_xpath, yinzi_code)  #选择监测因子

            #信号属相选择数字信号
            shuzixinhao = "数字信号"
            xinhaoshuxing_xpath = "/html/body/form/div/div/table[2]/tbody/tr[1]/td[2]/select"
            ...
            xieyixuanzeliebiao_xpath = "/html/body/form/div/div/table[2]/tbody/tr[1]/td[4]/select"
            self.activebrowser.findElementByXpathAndSelectOptionsNum(0,xieyixuanzeliebiao_xpath, xieyi)  # 选择协议

            #点击全选
            quanxian_xpath = "/html/body/form/div/div/table[3]/tbody/tr/td[1]/div/div[2]/table/tbody/tr[6]/td[1]/input"
            self.activebrowser.findEleAndClick(0, "xpath", quanxian_xpath)  # 点击“全选”选框

            #点击保存
            save_xpath = "/html/body/form/div/div/table[5]/tbody/tr/td/input[2]"
    ...
    def setLogLevel(self):
        #处于监测因子列表页
        #点击“高级配置”
        gaojipeizhi_xpath = "/html/body/form/div/div/table[3]/tbody/tr/td/input[1]"
        self.activebrowser.findEleAndClick(0, "xpath", gaojipeizhi_xpath)  # 点击“高级配置”
        dayijibie_option_text = "develop"
        dayinjibie_select_xpath = "/html/body/form/div/div/table[2]/tbody/tr/td[1]/table/tbody/tr/td[2]/select"
        self.activebrowser.findElementByXpathAndSelectOptionsNum(0, dayinjibie_select_xpath, dayijibie_option_text)  # 选择打印级别为develop

        baocun_xpath = "/html/body/form/div/div/table[3]/tbody/tr/td/input[2]"
    ...
    def clickShangBaoPeiZhi(self):
        self.switchToOneFrame()
        shangbaopeizhi_link_text = "上报配置"
        self.activebrowser.findEleAndClick(0, "link_text", shangbaopeizhi_link_text )  # 点击“网络参数配置”
        print("已经点击【上报配置】")
        self.quiteCurrentFrame()

    #点击“有线网络配置”
    def clickYouXianWangLuoPeiZhi(self):
        self.switchToTwo_One_Frame()
        #点击“有线网络配置”
        jianceyinziliebiao_link_text = "有线网络配置"
        self.activebrowser.findEleAndClick(0, "link_text", jianceyinziliebiao_link_text )  # 点击“有线网络配置”
        print("已经点击【有线网络配置】")
        self.quiteCurrentFrame()

    #查看服务器1是否被选中，没有选中，则点击选择，否则，不做任何操作
    def checkFuWuQI(self):
        self.switchToTwo_Two_Frame()
        self.activebrowser.delayTime(3)
        fuwuqi_1_input_xpath = "/html/body/form/div/div[3]/div[2]/table/tbody/tr/td/table/tbody/tr[2]/td[1]/input"
        fuwuqi_1_input_ele = self.activebrowser.findELe("xpath",fuwuqi_1_input_xpath)
        is_checked = self.activebrowser.input_is_checked(fuwuqi_1_input_ele)
        if not is_checked: #如果没有选中， 则点击选中
            self.activebrowser.findEleAndClick(0,"xpath",fuwuqi_1_input_xpath)
            self.activebrowser.outPutMyLog("点击选中服务器1")
        self.quiteCurrentFrame()

    #添加上报平台,默认写有线网络第一个服务器地址
    def addServiceConfig(self):
        self.switchToTwo_Two_Frame()
        fuwuqidizhi_xpath = "/html/body/form/div/div[3]/div[2]/table/tbody/tr/td/table/tbody/tr[2]/td[3]/input"
        ...
        fuwuqiduankou_xpath = "/html/body/form/div/div[3]/div[2]/table/tbody/tr/td/table/tbody/tr[2]/td[4]/input"
        ...
        select_xieyi_xpath = "/html/body/form/div/div[3]/div[2]/table/tbody/tr/td/table/tbody/tr[2]/td[5]/select[1]"
        #选择某个协议：
        self.activebrowser.findElementByXpathAndSelectOptionsNum(0,select_xieyi_xpath,shangbao_pingtai_xieyi_option_text)


        #点击“保存”
        baocun_xpath = "/html/body/form/div/table/tbody/tr/td/input[1]"
    ...
    def clickXieRuSheBei(self):
        self.switchToOneFrame()
        xierushebei_button_xpath = "/html/body/div/div[7]/input"
        self.activebrowser.findEleAndClick(0, "xpath", xierushebei_button_xpath)   # 点击“写入设备”
    ...
    def run(self):
        ...
        if is_continue:   #如果全部都有，则执行后续操作
            ...
            # 点击“有线网络配置”
            self.clickYouXianWangLuoPeiZhi()
...
if __name__ == '__main__':
    ...
    wc = WebVFiveOneConfig(select_xie_yi,select_jian_kong_yin_zi_list,ip,service_ip,service_port,device_id)
    wc.run()
